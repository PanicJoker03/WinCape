...
namespace ui{
	...
	public:
		...
		void registerClass(WCH_STR_CONST name = w_cape::Defaults::WND_NAM)
		{
		...
		ui::Base::Handle createHandle(WCH_STR_CONST name,
	...
	void ui::Manager::registerClass(WCH_STR_CONST name)
	{
		ManagerImpl::instance().registerClass(name);
	}
	ui::Base::Handle ui::Manager::createHandle(WCH_STR_CONST className,
		WCH_STR_CONST text, WND_STY style, const CAPE_RECT& rect,
		ui::Base::Handle parent, WNDX_STY exStyle)
	{
	...
	void ui::Manager::defaultFont(WCH_STR_CONST fontName)
	{
