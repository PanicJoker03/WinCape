...
namespace dat_store{
	...
	void dat_store::File::open(WCH_STR_CON filePath, DSRED_ACCES mode)
	{
	...
	void dat_store::File::create(WCH_STR_CON filePath, DSRED_ACCES mode)
	{
	...
	void dat_store::File::truncate(WCH_STR_CON filePath)
	{
	...
	void dat_store::File::remove(WCH_STR_CON filePath)
	{
